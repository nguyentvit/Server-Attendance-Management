        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PathImg = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SumaryHour = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Shifts",
                columns: new[] { "ShiftId", "ShiftName", "Time_In", "Time_Out" },
                values: new object[,]
                {
                    { new Guid("13a27559-42be-4984-8e5c-55331f5a039f"), "Morning", new TimeSpan(0, 7, 30, 0, 0), new TimeSpan(0, 11, 30, 0, 0) },
                    { new Guid("3a6ffedc-25d6-45da-8354-b7880eced953"), "Afternoon", new TimeSpan(0, 14, 0, 0, 0), new TimeSpan(0, 17, 30, 0, 0) }
                });
